...
class DeleteExcludeProductsByNameInputHandlerTest extends TestBase {
    @Autowired
    private DeleteExcludeProductsByNameInputHandler handler;
    ...
    @Test
    void execute() {
        createUser(ChatStatus.DELETE_EXCLUDE_PRODUCTS_BY_NAME);
        initDishes();
